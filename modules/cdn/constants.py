...
DEFAULT_HEADERS = {
    "User-Agent": ("ReconAutomationFramework/1.0 " "(CDN Detection)"),
    "Accept": "*/*",
...
RECOMMENDATIONS = {
    True: "A CDN was detected. Verify whether the provider "
    "matches the organization's expected infrastructure.",
    False: "No CDN fingerprints were detected. "
